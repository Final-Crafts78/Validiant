...
export const MINIMAL_TASK_FIELDS = 'id,title,client_name,status,pincode,assigned_to,created_at,notes,latitude,longitude,map_url,location_warning,individual_phone,individual_alt_phone';
