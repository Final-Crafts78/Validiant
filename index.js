...
html += "  if (currentUser.role === 'admin') {\n";
  ...
  html += "";
html += "// ═══════════════════════════════════════════════════════════════════════════";
html += "// DASHBOARD INITIALIZATION WITH ERROR HANDLING";
html += "// ═══════════════════════════════════════════════════════════════════════════";
html += "try {";
html += "  console.log('🔵 Dashboard loading...');";
html += "  console.log('Current user:', localStorage.getItem('currentUser'));";
html += "  ";
html += "  // Wait for DOM to be ready";
html += "  if (document.readyState === 'loading') {";
html += "    document.addEventListener('DOMContentLoaded', function() {";
html += "      console.log('✅ DOM ready, initializing menu');";
html += "      initMenu();";
html += "    });";
html += "  } else {";
html += "    console.log('✅ DOM already ready, initializing menu immediately');";
html += "    initMenu();";
html += "  }";
html += "} catch (err) {";
html += "  console.error('❌ CRITICAL: Dashboard initialization failed:', err);";
html += "  alert('Dashboard failed to load. Error: ' + err.message + '\\n\\nPlease refresh the page.');";
html += "}";
html += "";
html += "</script>";
